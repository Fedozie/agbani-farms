...
const DiscoverMore = ({ heading, text }: CTAProps) => {
  ...
  return (
    <div className="leading-none relative w-full bg-primary-green py-10 px-5 lg:py-20 lg:px-32 flex flex-col gap-8 lg:flex-col lg:gap-8 justify-between items-center">
      <div
      ...
      <div className="z-10">
        <p className="text-white font-bold text-center text-[2rem] lg:text-[3.125rem]">
          {heading}
        </p>
      </div>

      <div className="w-full lg:w-[60%] z-10 lg:py-0">
        <p className="text-white font-medium text-center text-lg  lg:text-xl">
          {text}
        </p>
      </div>
